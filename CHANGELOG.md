...
- `design-audit install --skills` — copy skill files into any project's `.claude/` directory
- `design-audit run [url] [WxH]` — run layout extraction directly via playwright-cli
- `design-audit --help` and `design-audit --version` CLI commands
